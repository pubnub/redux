  ...
  return function networkStatusReducer(
    ...
    switch (action.type) {
      ...
      case ErrorStatusActionType.MALFORMED_RESPONSE_EVENT:
          newState.malformedResponse = [ ...state.malformedResponse, action.payload ];
          return newState;
      ...
      case ErrorStatusActionType.REQUEST_MESSAGE_COUNT_EXCEED_EVENT:
          newState.requestMessageCountExceeded = [ ...state.requestMessageCountExceeded, action.payload ];
          return newState;
      ...
      case ErrorStatusActionType.TIMEOUT_CONNECTION_EVENT:
          newState.timeoutConnection = [ ...state.timeoutConnection, action.payload ];
          return newState;
