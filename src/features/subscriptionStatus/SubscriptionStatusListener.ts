...
export const reconnected = (payload: SubscriptionStatusResponse): ReconnectedAction => ({
  type: SubscriptionStatusActionType.RECONNECTED_EVENT,
  payload,
});

export const connected = (payload: SubscriptionStatusResponse): ConnectedAction => ({
